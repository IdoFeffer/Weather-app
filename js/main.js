...
async function fetchFiveDayForecast(lat, lon) {
  // Use the imported API_KEY instead of a hardcoded key
  const res = await fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=${API_KEY}&units=metric&lang=he`)
